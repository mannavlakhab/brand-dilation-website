        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (!isMobileDevice()) {
                ...
                document.getElementById('redirect-message').style.display = 'none';
                                ...
                                <div class='ab-o-oa' aria-hidden='true'>
                    <div class='ZAnhre'>
                    <img class='wF0Mmb' src='../assets/phone_cat.svg' width='300px' height='300px' alt=''></div>
                    <div class='ab-o-oa-r'><div class='ab-o-oa-qc-V'>UPI App Payment Not Supported on This Device</div>
                    <div class='ab-o-oa-qc-r'>UPI payments can only be processed on mobile devices. Please switch to a mobile device to complete your payment.</div></div>
                </div>
                <style>

...
<div class="ZAnhre">
                ...
                <div class="ab-o-oa-r"><div class="ab-o-oa-qc-V">Your process is continued </div>
                 <div class="ab-o-oa-qc-r">For more info Go to <a href="../profile.php">"Profile Page"</a></div></div><br>
...
function getUserDetails($user_id) {
    global $conn;
    $sql = "SELECT user_id, first_name, last_name, email, phone_number, address_1, address_2 FROM users WHERE user_id = ?";
...
<div class="row">
  <div class="col-75">
    ...
    <option value="<?php echo htmlspecialchars($user['address_1']); ?>"><?php echo htmlspecialchars($user['address_1']); ?></option>
    <option value="<?php echo htmlspecialchars($user['address_2']); ?>"><?php echo htmlspecialchars($user['address_2']); ?></option>
    ...
    <div class="container">
      ...
      <p>  
        <?php foreach ($_SESSION['cart'] as $cart_key => $quantity): ?>
          <?php list($product_id, $variation_id) = explode('_', $cart_key); ?>
          <?php
            ...
            $product_price = ($product['price'] + $product['price_modifier']) * $quantity;
          ?>
          <p><?php echo htmlspecialchars($product_name); ?><span class="price"><?php echo '₹' . number_format($product_price, 2); ?></span></p>
        <?php endforeach; ?>
      </p>
      <hr>

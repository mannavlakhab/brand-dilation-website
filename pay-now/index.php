...
$payment_link = "upi://pay?pa=amarnavlakha2@okhdfcbank&am={$total_price}&url=https://hello.com";
...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="row mb-4">
            <div class="col-lg-8 mx-auto text-center">
                <h1 class="display-6">Pre Pay Payment</h1>
            </div>
        </div>
        ...
        <div class="row">
            ...
            foreach ($products as $product): ?>
                                    <p>
                                        ...
                                        <?php echo htmlspecialchars($product['model']); ?><br>
                                        Product Quantity:
                                        <?php echo htmlspecialchars($product['product_quantity']); ?><br>
                                        Total Price: <?php echo htmlspecialchars($total_price); ?>
                                    </p>
                                    <?php endforeach; ?>
                                </div>
                                <form method="post"
                                    action="../pay-now/form_cash.php?pd=qr&order_id=<?php echo htmlspecialchars($order_id); ?>"
                                    ...
                                    <button
                                        style="margin:2%;background-color: #1d8b00; border: 1px solid rgba(27, 31, 35, 0.15);color:#fff"
                                        type="submit" class="btn btn-trick-new">Confirm Cash Payment</button>
                                </form>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="qr_sec_new">
                                                    <h4> <img src="../pages/brand/full.svg" id="logo" alt="logo here">
                                                    </h4>
                                            ...
                                            <form method="post"
                                                action="../pay-now/form.php?pd=qr&order_id=<?php echo htmlspecialchars($order_id); ?>"
                                                enctype="multipart/form-data">
                                                <label>
                                                    <select name="payment_status" required>
                                                        <option value="" selected disabled>Select your payment status
                                                        </option>
                                                ...
                                                <input type="hidden" name="payment_details"
                                                    value="<?php echo htmlspecialchars($payment_link); ?>">
                                                <input type="submit" style="margin:2%;background-color: #1d8b00;
    border: 1px solid rgba(27, 31, 35, 0.15);color:#fff" name="submit_order" value="Submit QR Payment "
                                                    class="btn btn-trick-new">
                            ...
                            <div id="upi-app" class="tab-pane fade pt-3">
                                ...
                                function isMobileDevice() {
                                    ...
                                    return (/android|iPad|iPhone|iPod|windows phone|kindle|silk|blackberry|playbook|tablet/i
                                        .test(userAgent.toLowerCase()));
                                }

                                document.addEventListener('DOMContentLoaded', function() {
                                    if (!isMobileDevice()) {
                                        document.getElementById('unsupported-device-message').style.display =
                                            'block';
                                ...
                                <div id="unsupported-device-message" style="display: none;">
                                    <div class='ab-o-oa' aria-hidden='true'>
                                        <div class='ZAnhre'>
                                            <img class='wF0Mmb' src='../assets/phone_cat.svg' width='300px'
                                                height='300px' alt=''>
                                        </div>
                                        <div class='ab-o-oa-r'>
                                            <div class='ab-o-oa-qc-V'>UPI App Payment Not Supported on This Device</div>
                                            <div class='ab-o-oa-qc-r'>UPI payments can only be processed on mobile
                                                devices. Please switch to a mobile device to complete your payment.
                                            </div>
                                        </div>
                                    </div>
                                    <style>
                                ...
                                <div id="redirect-message">
                                    <button onclick="window.location.href='<?php echo htmlspecialchars($payment_link); ?>'" class="pay">Pay Now</button>
                                    <p>If not redirected, <a href="<?php echo htmlspecialchars($payment_link); ?>">click
                                            here</a>.</p>

                                    <p><b>Notes:</b> If payment not done it will consider as cash.</p>
                                    <form method="post"
                                        action="../pay-now/form.php?pd=upi&order_id=<?php echo htmlspecialchars($order_id); ?>"
                                        enctype="multipart/form-data">
                                        <label>
                                            <select name="payment_status" required>
    ...
    border: 1px solid rgba(27, 31, 35, 0.15);color:#fff" class="btn-trick-new" type="submit"
                                            value="Submit mobile Payment">
                                    </form>
                                </div>
                            </div> <!-- End -->
                        </div>

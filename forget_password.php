...
function sendEmail($recipientEmail, $recipientName, $subject, $body) {
    ...
    try {
        ...
        $mail->Port       = 587; // Correct TCP port to connect to
...
To Forget Password, please click the following button:
            </p>
            <button
              style='
                margin: 0;
            ...
            <a  style='
                ...
                font-family: Poppins;
                letter-spacing: 0.56px;
              ' href='$reset_link'>Reset Password</a>
            </button>
               <p
              style='
                margin: 0;
              ...
              '
            >
            This link is valid for <span style='font-weight: 600; color: #1f1f1f;'>10 minutes</span>.
            </p>
          </div>
        </div>
...
<!-- adderss -->
        ...
        if (sendEmail($email, $user_id, $subject, $message)) {
            echo "A password reset link has been sent to your email.";
        } else {
            echo "<p class='fails'>Failed to send email.</p>";
        }
    } else {
...
<body>
    <div class="container_login">
            <div class="header_login">
                ...
                <h1>Forget Password to <em id="brand">Brand</em> <em id="dilation">Dilation</em></h1>
            </div>

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = $conn->prepare("SELECT email, password FROM users WHERE user_id = ?");
        ...
        >
          <div style='width: 100%; max-width: 489px; margin: 0 auto;'>
            ...
            <p
              ...
              '
            >
              Thank you for choosing Brand Dilation. Your id's password has ben changed Successfully.If this wasn't you, please <a href='http://192.168.59.24/pages/help.html'>contact support</a> immediately.
            </p>
            <p
              style='
                margin: 0;
...
<body>
    <div class="container_login">
            <div class="header_login">
                ...
                <h1>Change Password to <em id="brand">Brand</em> <em id="dilation">Dilation</em></h1>
    ...
    <?php endif; ?>
            ...
            <input  placeholder="Current Password" type="password" id="current_password" name="current_password" required class="inputField" >
             </div>
            <div class="form-group">
            <input  placeholder="New Password" type="password" id="new_password" name="new_password" required class="inputField" >
             </div>
            <div class="form-group">
                <input  placeholder="New Password" type="password" id="confirm_password" name="confirm_password" required class="inputField" >
                </div>
